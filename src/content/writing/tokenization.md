...
![LLM meme showing matrix multiplication as a virtual girlfriend](/img/virtualgfmeme.jpg)
...
This also explains why LLMs are historically bad at simple arithmetic or why they struggle with harder-to-tokenize languages like Japanese. The workaround for the first two problems, we've figured out, is to let the model run Python code! When we ask a modern LLM to count the r's in strawberry, it secretly runs a script:
...
I'll quickly mention a few problems with the way we currently tokenize language:

- The Case-Sensitivity Glitch: To a tokenizer, Hello, hello, and HELLO are often three completely different "numbers." The model sees three “different things” and that weakens learning.
