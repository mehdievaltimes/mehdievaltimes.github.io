...
The model combines a pretrained ResNet-18 (a type of convolutional neural network that’s great at recognizing visual patterns) with a linear regression layer that maps the network’s output to predicted fMRI responses. The model was trained on [BOLD5000](https://bold5000-dataset.github.io/website/), a collection of fMRI data from three subjects viewing 4,916 unique images (I wonder what the other 84 images were that they didn't include). 
