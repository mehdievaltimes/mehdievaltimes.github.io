...
When we see the same phenomenon in artificial neural networks (like the Spiderman neuron), it suggests that representing concepts invariantly might be a universal property of how deep learning architectures (both biological and synthetic) organize information.
